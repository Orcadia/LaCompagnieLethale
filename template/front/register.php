    ...
    <div class=" col-md-10 mx-auto bg-terminal mt-4 ps-2">
        ...
        <form action="/register" method="post">
            <div class="form-group">
                ...
                <div class="invalid-feedback"><?= $data['username_err'] ?? ''; ?></div><br>
                ...
                <div class="invalid-feedback"><?= $data['email_err'] ?? ''; ?></div><br>
                ...
                <div class="invalid-feedback"><?= $data['password_err'] ?? ''; ?></div><br>
                ...
                <div class="invalid-feedback"><?= $data['confirm_password_err'] ?? ''; ?></div><br>
            </div>
